...
window.SwaggerTranslator.learn({
    ...
    "Raw":"Grezzo (raw***REMOVED***",
    "can't parse JSON.  Raw result":"non è possibile parsare il JSON. Risultato grezzo (raw***REMOVED***.",
    ...
    "Response Content Type":"Tipo di contenuto (content type***REMOVED*** della risposta",
    ...
    "Can't read from server.  It may not have the appropriate access-control-origin settings.":"Non è possibile leggere dal server. Potrebbe non avere le impostazioni di controllo accesso origine (access-control-origin***REMOVED*** appropriate.",
    "Please specify the protocol for":"Si prega di speci***REMOVED***care il protocollo per",
