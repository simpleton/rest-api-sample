...
window.SwaggerTranslator.learn({
    ...
    "Headers":"En-têtes",
    "Try it out!":"Testez !",
    "Show/Hide":"Af***REMOVED***cher/Masquer",
    ...
    "Model Schema":"Dé***REMOVED***nition du modèle",
    "Model":"Modèle",
    "apply":"appliquer",
    ...
    "Please specify the protocol for":"Veuillez spéci***REMOVED***er un protocole pour",
    "Can't read swagger JSON from":"Impossible de lire le JSON swagger à partir de",
    "Finished Loading Resource Information. Rendering Swagger UI":"Chargement des informations terminé. Af***REMOVED***chage de Swagger UI",
